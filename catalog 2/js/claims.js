...
(function () {
  const claimCases = [
    ...
    { title:'達文西手術', series:'常見理賠案例 08', folder:'common outpatient organ cancer', categories:['medical','surgery','cancer'], tags:['#醫療實支','#手術定額','#癌症'], summary:'高額自費手術最能看出醫療實支額度差異，也是客戶最容易有感的案例。', keywords:'達文西 達文西手術 自費手術 微創 癌症 醫療實支 達文西機械手臂', url:'https://godzillapaul.github.io/claim-da_Vinci-08/' },
    { title:'椎間盤', series:'常見理賠案例 09', folder:'common back', categories:['medical','surgery','accident-medical'], tags:['#醫療實支','#手術定額'], summary:'椎間盤治療可能橫跨復健、手術與自費項目，適合拿來做保障檢查。', keywords:'椎間盤 椎間盤突出 腰椎 脊椎 腰背 手術 醫療實支 退化 破裂 神經壓迫', url:'https://godzillapaul.github.io/claim-intervertebral_disc-09/' },
    { title:'幼兒常見住院', series:'常見理賠案例 10', folder:'common children', categories:['medical','hospital'], tags:['#醫療實支','#住院定額'], summary:'幼兒常見疾病住院，最能讓父母理解醫療保障不是大人才需要。', keywords:'幼兒常見住院 幼兒 兒童 小孩 腺病毒 腸病毒 抽搐痙攣 熱性痙攣 RSV 支氣管炎 玫瑰疹 流感 發燒 住院 醫療實支', url:'https://godzillapaul.github.io/claim-children_hospitalized-10/' },
